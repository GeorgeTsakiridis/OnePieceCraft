...
public class JSONGenerator {
    ...
    private static String RECIPE_DIR = null;
    private static final Set<String> USED_OD_NAMES = new TreeSet<>();

    private static void setupDir() {
        if (RECIPE_DIR == null) {
            RECIPE_DIR = "C:/Users/georg/Desktop/Programming/Minecraft/One Piece Craft 1.12.2/recipes/";
        }
    }
    ...
    public static void addSmelting(Block in, ItemStack result, float xp) { addSmelting(new ItemStack(in), result, xp, 200); }
    public static void addSmelting(ItemStack in, ItemStack result, float xp, int cookTime) {
        ...
        while (f.exists()) {
            count++;
            f = new File(RECIPE_DIR, result.getItem().getRegistryName().getResourcePath() + suffix.concat(String.valueOf(count)) + ".json");
        }
