...
public class OPDevilFruits {
    ...
    public static void registerPowers(){
        ...
        PowerHandler.addPower(new int[]{2400, 2200, 2000, 1800, 1600}, new int[]{10, 20, 30, 45}, "GomuGear4", "Gomu Gomu no: Gear 4", GOMU, 4, "gear4");
        ...
        PowerHandler.addPower(new int[]{700, 700, 700 ,700, 700}, new int[]{1, 2, 3, 4}, "ClearSkating","Skating (Invisibility)", SUKE, 1, "skating");
        PowerHandler.addPower(new int[]{600, 600, 600, 600, 600}, new int[]{1, 2, 3, 4}, "Room","Room", OPE, 1, "room");
        ...
        PowerHandler.addPower(new int[]{600, 550, 500, 450, 400}, new int[]{20, 40, 65, 90}, "WhiteOut", "White Out", MOKU, 3, "white_out");
        PowerHandler.addPower(new int[]{2200, 2000, 1800, 1600, 1400}, new int[]{10, 15, 25, 40}, "WhiteLauncher", "White Launcher", MOKU, 4, "white_launcher");
        ...
        PowerHandler.addPower(new int[]{2200, 2000, 1800, 1600, 1400}, new int[]{10, 15, 25, 40}, "SoraNoMichi", "Sora no Michi", ITO, 4, "sora_no_michi");
    }
