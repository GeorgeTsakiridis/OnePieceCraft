...
public class BigHouse1Component extends StructureVillagePieces.House1{
    ...
    public BigHouse1Component(){

    }

    public BigHouse1Component(StructureBoundingBox boundingBox, EnumFacing par5){
        this.setCoordBaseMode(par5);
        this.boundingBox = boundingBox;
    }

    public static BigHouse1Component buildComponent(List pieces, int p1, int p2, int p3, EnumFacing p4){
        ...
        return canVillageGoDeeper(boundingBox) && StructureComponent.findIntersecting(pieces, boundingBox) == null ? new BigHouse1Component(boundingBox, p4) : null;
    }
    ...
    public void spawnActualHouse(World world, Random rand, StructureBoundingBox sbb){
        ...
        setBlock(world, sbb, 0, j + 5, 12, Blocks.STONE_BRICK_STAIRS.getDefaultState(), 3);
        setBlock(world, sbb, 0, j + 6, 6, Blocks.STONE_BRICK_STAIRS.getDefaultState(), 2);
        setBlock(world, sbb, 0, j + 6, 11, Blocks.STONE_BRICK_STAIRS.getDefaultState(), 3);
        ...
        setBlock(world, sbb, 1, j + 5, 3, Blocks.PLANKS.getDefaultState(), 0);
        setBlock(world, sbb, 1, j + 5, 4, Blocks.PLANKS.getDefaultState(), 0);
        ...
        setBlock(world, sbb, 1, j + 5, 12, Blocks.STONE_BRICK_STAIRS.getDefaultState(), 3);
        ...
        setBlock(world, sbb, 1, j + 6, 3, Blocks.STONE_BRICK_STAIRS.getDefaultState(), 0);
        ...
        setBlock(world, sbb, 1, j + 6, 6, Blocks.STONE_BRICK_STAIRS.getDefaultState(), 0);
        setBlock(world, sbb, 1, j + 6, 7, Blocks.PLANKS.getDefaultState(), 0);
        setBlock(world, sbb, 1, j + 6, 8, Blocks.GLASS_PANE.getDefaultState(), 0);
        setBlock(world, sbb, 1, j + 6, 9, Blocks.GLASS_PANE.getDefaultState(), 0);
        setBlock(world, sbb, 1, j + 6, 10, Blocks.PLANKS.getDefaultState(), 0);
        setBlock(world, sbb, 1, j + 6, 11, Blocks.STONE_BRICK_STAIRS.getDefaultState(), 3);
        setBlock(world, sbb, 1, j + 7, 7, Blocks.STONE_BRICK_STAIRS.getDefaultState(), 2);
        setBlock(world, sbb, 1, j + 7, 8, Blocks.PLANKS.getDefaultState(), 0);
        ...
        setBlock(world, sbb, 1, j + 8, 8, Blocks.STONE_BRICK_STAIRS.getDefaultState(), 2);
        ...
        setBlock(world, sbb, 2, j + 4, 6, Blocks.PLANKS.getDefaultState(), 0);
        setBlock(world, sbb, 2, j + 4, 7, Blocks.PLANKS.getDefaultState(), 0);
        setBlock(world, sbb, 2, j + 4, 8, Blocks.PLANKS.getDefaultState(), 0);
        setBlock(world, sbb, 2, j + 4, 9, Blocks.PLANKS.getDefaultState(), 0);
        setBlock(world, sbb, 2, j + 4, 11, Blocks.PLANKS.getDefaultState(), 0);
        setBlock(world, sbb, 2, j + 5, 1, Blocks.LOG2.getDefaultState(), 5);
        setBlock(world, sbb, 2, j + 5, 2, Blocks.CHEST.getDefaultState(), 3);
        setBlock(world, sbb, 2, j + 5, 11, Blocks.PLANKS.getDefaultState(), 0);
        setBlock(world, sbb, 2, j + 5, 12, Blocks.STONE_BRICK_STAIRS.getDefaultState(), 3);
        ...
        setBlock(world, sbb, 2, j + 7, 4, Blocks.STONE_BRICK_STAIRS.getDefaultState(), 0);
        setBlock(world, sbb, 2, j + 7, 5, Blocks.STONE_BRICK_STAIRS.getDefaultState(), 0);
        setBlock(world, sbb, 2, j + 7, 6, Blocks.STONE_BRICK_STAIRS.getDefaultState(), 0);
        setBlock(world, sbb, 2, j + 7, 7, Blocks.STONE_BRICK_STAIRS.getDefaultState(), 0);
        setBlock(world, sbb, 2, j + 7, 10, Blocks.STONE_BRICK_STAIRS.getDefaultState(), 3);
        setBlock(world, sbb, 2, j + 8, 8, Blocks.STONE_BRICK_STAIRS.getDefaultState(), 2);
        setBlock(world, sbb, 2, j + 8, 9, Blocks.STONE_BRICK_STAIRS.getDefaultState(), 3);
        ...
        setBlock(world, sbb, 3, j + 1, 3, Blocks.OAK_FENCE.getDefaultState(), 0);
        setBlock(world, sbb, 3, j + 1, 4, Blocks.OAK_FENCE.getDefaultState(), 0);
        ...
        setBlock(world, sbb, 3, j + 3, 11, Blocks.GLASS_PANE.getDefaultState(), 0);
        setBlock(world, sbb, 3, j + 4, 1, Blocks.PLANKS.getDefaultState(), 0);
        setBlock(world, sbb, 3, j + 4, 2, Blocks.PLANKS.getDefaultState(), 0);
        setBlock(world, sbb, 3, j + 4, 3, Blocks.PLANKS.getDefaultState(), 0);
        setBlock(world, sbb, 3, j + 4, 4, Blocks.PLANKS.getDefaultState(), 0);
        setBlock(world, sbb, 3, j + 4, 5, Blocks.PLANKS.getDefaultState(), 0);
        setBlock(world, sbb, 3, j + 4, 6, Blocks.PLANKS.getDefaultState(), 0);
        setBlock(world, sbb, 3, j + 4, 7, Blocks.PLANKS.getDefaultState(), 0);
        setBlock(world, sbb, 3, j + 4, 8, Blocks.PLANKS.getDefaultState(), 0);
        setBlock(world, sbb, 3, j + 4, 9, Blocks.PLANKS.getDefaultState(), 0);
        ...
        setBlock(world, sbb, 3, j + 5, 11, Blocks.PLANKS.getDefaultState(), 0);
        ...
        setBlock(world, sbb, 3, j + 8, 0, Blocks.STONE_BRICK_STAIRS.getDefaultState(), 0);
        setBlock(world, sbb, 3, j + 8, 1, Blocks.STONE_BRICK_STAIRS.getDefaultState(), 0);
        ...
        setBlock(world, sbb, 3, j + 8, 8, Blocks.STONE_BRICK_STAIRS.getDefaultState(), 0);
        ...
        setBlock(world, sbb, 4, j + 1, 3, Blocks.OAK_FENCE.getDefaultState(), 0);
        setBlock(world, sbb, 4, j + 1, 4, Blocks.OAK_FENCE.getDefaultState(), 0);
        setBlock(world, sbb, 4, j + 1, 11, Blocks.STONE.getDefaultState(), 6);
        setBlock(world, sbb, 4, j + 2, 1, Blocks.GLASS_PANE.getDefaultState(), 0);
        setBlock(world, sbb, 4, j + 2, 11, Blocks.GLASS_PANE.getDefaultState(), 0);
        setBlock(world, sbb, 4, j + 3, 1, Blocks.GLASS_PANE.getDefaultState(), 0);
        setBlock(world, sbb, 4, j + 3, 11, Blocks.GLASS_PANE.getDefaultState(), 0);
        setBlock(world, sbb, 4, j + 4, 1, Blocks.PLANKS.getDefaultState(), 0);
        setBlock(world, sbb, 4, j + 4, 2, Blocks.PLANKS.getDefaultState(), 0);
        setBlock(world, sbb, 4, j + 4, 3, Blocks.PLANKS.getDefaultState(), 0);
        setBlock(world, sbb, 4, j + 4, 4, Blocks.PLANKS.getDefaultState(), 0);
        setBlock(world, sbb, 4, j + 4, 5, Blocks.PLANKS.getDefaultState(), 0);
        setBlock(world, sbb, 4, j + 4, 6, Blocks.PLANKS.getDefaultState(), 0);
        setBlock(world, sbb, 4, j + 4, 7, Blocks.PLANKS.getDefaultState(), 0);
        setBlock(world, sbb, 4, j + 4, 8, Blocks.PLANKS.getDefaultState(), 0);
        ...
        setBlock(world, sbb, 4, j + 5, 11, Blocks.PLANKS.getDefaultState(), 0);
        setBlock(world, sbb, 4, j + 5, 12, Blocks.STONE_BRICK_STAIRS.getDefaultState(), 3);
        setBlock(world, sbb, 4, j + 6, 1, Blocks.GLASS_PANE.getDefaultState(), 0);
        ...
        setBlock(world, sbb, 4, j + 8, 8, Blocks.STONE_BRICK_STAIRS.getDefaultState(), 2);
        ...
        setBlock(world, sbb, 5, j + 4, 3, Blocks.PLANKS.getDefaultState(), 0);
        setBlock(world, sbb, 5, j + 4, 4, Blocks.PLANKS.getDefaultState(), 0);
        setBlock(world, sbb, 5, j + 4, 5, Blocks.PLANKS.getDefaultState(), 0);
        setBlock(world, sbb, 5, j + 4, 6, Blocks.PLANKS.getDefaultState(), 0);
        setBlock(world, sbb, 5, j + 4, 7, Blocks.PLANKS.getDefaultState(), 0);
        setBlock(world, sbb, 5, j + 4, 8, Blocks.PLANKS.getDefaultState(), 0);
        setBlock(world, sbb, 5, j + 4, 9, Blocks.PLANKS.getDefaultState(), 0);
        ...
        setBlock(world, sbb, 5, j + 5, 2, Blocks.CHEST.getDefaultState(), 3);
        setBlock(world, sbb, 5, j + 5, 11, Blocks.PLANKS.getDefaultState(), 0);
        ...
        setBlock(world, sbb, 5, j + 6, 11, Blocks.STONE_BRICK_STAIRS.getDefaultState(), 3);
        setBlock(world, sbb, 5, j + 7, 0, Blocks.STONE_BRICK_STAIRS.getDefaultState(), 1);
        ...
        setBlock(world, sbb, 5, j + 7, 5, Blocks.STONE_BRICK_STAIRS.getDefaultState(), 1);
        setBlock(world, sbb, 5, j + 7, 6, Blocks.STONE_BRICK_STAIRS.getDefaultState(), 1);
        setBlock(world, sbb, 5, j + 7, 7, Blocks.STONE_BRICK_STAIRS.getDefaultState(), 1);
        setBlock(world, sbb, 5, j + 7, 10, Blocks.STONE_BRICK_STAIRS.getDefaultState(), 3);
        setBlock(world, sbb, 5, j + 8, 8, Blocks.STONE_BRICK_STAIRS.getDefaultState(), 2);
        setBlock(world, sbb, 5, j + 8, 9, Blocks.STONE_BRICK_STAIRS.getDefaultState(), 3);
        setBlock(world, sbb, 6, j + 0, 1, Blocks.DIRT.getDefaultState(), 0);
        setBlock(world, sbb, 6, j + 0, 2, Blocks.DIRT.getDefaultState(), 0);
        setBlock(world, sbb, 6, j + 0, 3, Blocks.DIRT.getDefaultState(), 0);
        setBlock(world, sbb, 6, j + 0, 4, Blocks.DIRT.getDefaultState(), 0);
        setBlock(world, sbb, 6, j + 0, 5, Blocks.DIRT.getDefaultState(), 0);
        setBlock(world, sbb, 6, j + 0, 6, Blocks.DIRT.getDefaultState(), 0);
        ...
        setBlock(world, sbb, 6, j + 3, 4, Blocks.GLASS_PANE.getDefaultState(), 0);
        ...
        setBlock(world, sbb, 6, j + 4, 7, Blocks.PLANKS.getDefaultState(), 0);
        setBlock(world, sbb, 6, j + 4, 8, Blocks.PLANKS.getDefaultState(), 0);
        setBlock(world, sbb, 6, j + 4, 9, Blocks.PLANKS.getDefaultState(), 0);
        ...
        setBlock(world, sbb, 6, j + 5, 3, Blocks.LOG2.getDefaultState(), 9);
        ...
        setBlock(world, sbb, 6, j + 6, 2, Blocks.STONE_BRICK_STAIRS.getDefaultState(), 1);
        ...
        setBlock(world, sbb, 6, j + 6, 11, Blocks.STONE_BRICK_STAIRS.getDefaultState(), 3);
        ...
        setBlock(world, sbb, 7, j + 4, 7, Blocks.PLANKS.getDefaultState(), 0);
        setBlock(world, sbb, 7, j + 4, 8, Blocks.PLANKS.getDefaultState(), 0);
        setBlock(world, sbb, 7, j + 4, 9, Blocks.PLANKS.getDefaultState(), 0);
        ...
        setBlock(world, sbb, 7, j + 5, 2, Blocks.STONE_BRICK_STAIRS.getDefaultState(), 1);
        setBlock(world, sbb, 7, j + 5, 3, Blocks.STONE_BRICK_STAIRS.getDefaultState(), 1);
        ...
        setBlock(world, sbb, 7, j + 5, 6, Blocks.PLANKS.getDefaultState(), 0);
        setBlock(world, sbb, 7, j + 5, 11, Blocks.PLANKS.getDefaultState(), 0);
        ...
        setBlock(world, sbb, 8, j + 4, 8, Blocks.PLANKS.getDefaultState(), 0);
        setBlock(world, sbb, 8, j + 4, 9, Blocks.PLANKS.getDefaultState(), 0);
        ...
        setBlock(world, sbb, 8, j + 5, 6, Blocks.PLANKS.getDefaultState(), 0);
        setBlock(world, sbb, 8, j + 5, 11, Blocks.PLANKS.getDefaultState(), 0);
        setBlock(world, sbb, 8, j + 5, 12, Blocks.STONE_BRICK_STAIRS.getDefaultState(), 3);
        setBlock(world, sbb, 8, j + 6, 6, Blocks.STONE_BRICK_STAIRS.getDefaultState(), 2);
        setBlock(world, sbb, 8, j + 6, 11, Blocks.STONE_BRICK_STAIRS.getDefaultState(), 3);
        setBlock(world, sbb, 8, j + 7, 7, Blocks.STONE_BRICK_STAIRS.getDefaultState(), 2);
        ...
        setBlock(world, sbb, 9, j + 2, 6, Blocks.GLASS_PANE.getDefaultState(), 0);
        ...
        setBlock(world, sbb, 9, j + 4, 9, Blocks.PLANKS.getDefaultState(), 0);
        setBlock(world, sbb, 9, j + 4, 10, Blocks.PLANKS.getDefaultState(), 0);
        setBlock(world, sbb, 9, j + 4, 11, Blocks.PLANKS.getDefaultState(), 0);
        setBlock(world, sbb, 9, j + 5, 5, Blocks.STONE_BRICK_STAIRS.getDefaultState(), 2);
        setBlock(world, sbb, 9, j + 5, 6, Blocks.PLANKS.getDefaultState(), 0);
        setBlock(world, sbb, 9, j + 5, 11, Blocks.PLANKS.getDefaultState(), 0);
        setBlock(world, sbb, 9, j + 5, 12, Blocks.STONE_BRICK_STAIRS.getDefaultState(), 3);
        setBlock(world, sbb, 9, j + 6, 6, Blocks.STONE_BRICK_STAIRS.getDefaultState(), 2);
        ...
        setBlock(world, sbb, 10, j + 4, 9, Blocks.PLANKS.getDefaultState(), 0);
        setBlock(world, sbb, 10, j + 4, 10, Blocks.PLANKS.getDefaultState(), 0);
        setBlock(world, sbb, 10, j + 4, 11, Blocks.PLANKS.getDefaultState(), 0);
        setBlock(world, sbb, 10, j + 5, 5, Blocks.STONE_BRICK_STAIRS.getDefaultState(), 2);
        setBlock(world, sbb, 10, j + 5, 6, Blocks.PLANKS.getDefaultState(), 0);
        setBlock(world, sbb, 10, j + 5, 8, Blocks.CHEST.getDefaultState(), 4);
        setBlock(world, sbb, 10, j + 5, 9, Blocks.CHEST.getDefaultState(), 4);
        setBlock(world, sbb, 10, j + 5, 11, Blocks.PLANKS.getDefaultState(), 0);
        setBlock(world, sbb, 10, j + 5, 12, Blocks.STONE_BRICK_STAIRS.getDefaultState(), 3);
        ...
        setBlock(world, sbb, 10, j + 8, 8, Blocks.STONE_BRICK_STAIRS.getDefaultState(), 2);
        ...
        setBlock(world, sbb, 11, j + 2, 8, Blocks.GLASS_PANE.getDefaultState(), 0);
        setBlock(world, sbb, 11, j + 2, 9, Blocks.GLASS_PANE.getDefaultState(), 0);
        ...
        setBlock(world, sbb, 11, j + 3, 8, Blocks.GLASS_PANE.getDefaultState(), 0);
        setBlock(world, sbb, 11, j + 3, 9, Blocks.GLASS_PANE.getDefaultState(), 0);
        ...
        setBlock(world, sbb, 11, j + 8, 8, Blocks.STONE_BRICK_STAIRS.getDefaultState(), 2);
        ...
        setBlock(world, sbb, 12, j + 6, 6, Blocks.STONE_BRICK_STAIRS.getDefaultState(), 2);
        setBlock(world, sbb, 12, j + 6, 11, Blocks.STONE_BRICK_STAIRS.getDefaultState(), 3);
        setBlock(world, sbb, 12, j + 7, 7, Blocks.STONE_BRICK_STAIRS.getDefaultState(), 2);
        setBlock(world, sbb, 12, j + 7, 10, Blocks.STONE_BRICK_STAIRS.getDefaultState(), 3);
        ...
        setBlock(world, sbb, 2, 2 + j, 6, Blocks.TORCH.getDefaultState(), 1);
        setBlock(world, sbb, 2, 5 + j, 5, Blocks.TORCH.getDefaultState(), 1);
        setBlock(world, sbb, 5, 2 + j, 6, Blocks.TORCH.getDefaultState(), 2);
        setBlock(world, sbb, 6, 2 + j, 7, Blocks.TORCH.getDefaultState(), 3);
        setBlock(world, sbb, 6, 2 + j, 10, Blocks.TORCH.getDefaultState(), 4);
        setBlock(world, sbb, 7, 2 + j, 12, Blocks.TORCH.getDefaultState(), 3);
        setBlock(world, sbb, 10, 2 + j, 12, Blocks.TORCH.getDefaultState(), 3);
        setBlock(world, sbb, 10, 6 + j, 7, Blocks.TORCH.getDefaultState(), 2);
        setBlock(world, sbb, 2, 1 + j, 10, Blocks.LADDER.getDefaultState(), 3);
        setBlock(world, sbb, 2, 2 + j, 10, Blocks.LADDER.getDefaultState(), 3);
        setBlock(world, sbb, 2, 3 + j, 10, Blocks.LADDER.getDefaultState(), 3);
        setBlock(world, sbb, 2, 4 + j, 10, Blocks.LADDER.getDefaultState(), 3);
        setBlock(world, sbb, 3, j + 2, 3, Blocks.WOODEN_PRESSURE_PLATE.getDefaultState(), 0);
        setBlock(world, sbb, 3, j + 2, 4, Blocks.WOODEN_PRESSURE_PLATE.getDefaultState(), 0);
        setBlock(world, sbb, 4, j + 2, 3, Blocks.WOODEN_PRESSURE_PLATE.getDefaultState(), 0);
        setBlock(world, sbb, 4, j + 2, 4, Blocks.WOODEN_PRESSURE_PLATE.getDefaultState(), 0);
        setBlock(world, sbb, 3, j + 1, 6, Blocks.CARPET.getDefaultState(), 14);
        setBlock(world, sbb, 3, j + 1, 7, Blocks.CARPET.getDefaultState(), 14);
        setBlock(world, sbb, 3, j + 1, 8, Blocks.CARPET.getDefaultState(), 14);
        setBlock(world, sbb, 3, j + 1, 9, Blocks.CARPET.getDefaultState(), 14);
        setBlock(world, sbb, 10, j + 1, 8, Blocks.CARPET.getDefaultState(), 14);
        setBlock(world, sbb, 10, j + 1, 9, Blocks.CARPET.getDefaultState(), 14);
        setBlock(world, sbb, 9, j + 1, 8, Blocks.CARPET.getDefaultState(), 14);
        setBlock(world, sbb, 9, j + 1, 9, Blocks.CARPET.getDefaultState(), 14);
        setBlock(world, sbb, 4, j + 1, 6, Blocks.CARPET.getDefaultState(), 14);
        setBlock(world, sbb, 4, j + 1, 7, Blocks.CARPET.getDefaultState(), 14);
        setBlock(world, sbb, 4, j + 1, 8, Blocks.CARPET.getDefaultState(), 14);
        setBlock(world, sbb, 4, j + 1, 9, Blocks.CARPET.getDefaultState(), 14);
        setBlock(world, sbb, 8, j + 1, 8, Blocks.CARPET.getDefaultState(), 14);
        setBlock(world, sbb, 8, j + 1, 9, Blocks.CARPET.getDefaultState(), 14);
        setBlock(world, sbb, 6, j + 1, 8, Blocks.CARPET.getDefaultState(), 14);
        setBlock(world, sbb, 6, j + 1, 9, Blocks.CARPET.getDefaultState(), 14);
        setBlock(world, sbb, 7, j + 1, 8, Blocks.CARPET.getDefaultState(), 14);
        setBlock(world, sbb, 7, j + 1, 9, Blocks.CARPET.getDefaultState(), 14);
        setBlock(world, sbb, 5, j + 1, 8, Blocks.CARPET.getDefaultState(), 14);
        setBlock(world, sbb, 5, j + 1, 9, Blocks.CARPET.getDefaultState(), 14);
        setBlock(world, sbb, 11, j + 4, 12, Blocks.DARK_OAK_STAIRS.getDefaultState(), 7);
        setBlock(world, sbb, 11, j + 4, 5, Blocks.DARK_OAK_STAIRS.getDefaultState(), 6);
        setBlock(world, sbb, 7, j + 4, 1, Blocks.DARK_OAK_STAIRS.getDefaultState(), 5);
        setBlock(world, sbb, 6, j + 4, 12, Blocks.DARK_OAK_STAIRS.getDefaultState(), 7);
        setBlock(world, sbb, 1, j + 4, 12, Blocks.DARK_OAK_STAIRS.getDefaultState(), 7);
        setBlock(world, sbb, 0, j + 4, 1, Blocks.DARK_OAK_STAIRS.getDefaultState(), 4);
        setBlock(world, sbb, 4, j + 1, 2, Blocks.OAK_STAIRS.getDefaultState(), 3);
        setBlock(world, sbb, 3, j + 1, 2, Blocks.OAK_STAIRS.getDefaultState(), 3);
        setBlock(world, sbb, 2, j + 1, 2, Blocks.OAK_STAIRS.getDefaultState(), 3);
        setBlock(world, sbb, 2, j + 1, 3, Blocks.OAK_STAIRS.getDefaultState(), 1);
        setBlock(world, sbb, 2, j + 1, 4, Blocks.OAK_STAIRS.getDefaultState(), 1);
        setBlock(world, sbb, 8, j + 1, 11, Blocks.DARK_OAK_DOOR.getDefaultState().withProperty(BlockDoor.HALF, BlockDoor.EnumDoorHalf.LOWER).withProperty(BlockDoor.FACING, EnumFacing.SOUTH).withProperty(BlockDoor.HINGE, BlockDoor.EnumHingePosition.RIGHT), 0);
        setBlock(world, sbb, 9, j + 1, 11, Blocks.DARK_OAK_DOOR.getDefaultState().withProperty(BlockDoor.HALF, BlockDoor.EnumDoorHalf.LOWER).withProperty(BlockDoor.FACING, EnumFacing.SOUTH).withProperty(BlockDoor.HINGE, BlockDoor.EnumHingePosition.LEFT), 0);
        setBlock(world, sbb, 8, j + 2, 11, Blocks.DARK_OAK_DOOR.getDefaultState().withProperty(BlockDoor.HALF, BlockDoor.EnumDoorHalf.UPPER).withProperty(BlockDoor.FACING, EnumFacing.SOUTH).withProperty(BlockDoor.HINGE, BlockDoor.EnumHingePosition.RIGHT), 0);
        setBlock(world, sbb, 9, j + 2, 11, Blocks.DARK_OAK_DOOR.getDefaultState().withProperty(BlockDoor.HALF, BlockDoor.EnumDoorHalf.UPPER).withProperty(BlockDoor.FACING, EnumFacing.SOUTH).withProperty(BlockDoor.HINGE, BlockDoor.EnumHingePosition.LEFT), 0);
        setBlock(world, sbb, 3, j + 5, 2, Blocks.BED.getDefaultState().withProperty(BlockBed.FACING, EnumFacing.SOUTH).withProperty(BlockBed.PART, BlockBed.EnumPartType.HEAD), 0);
        setBlock(world, sbb, 3, j + 5, 3, Blocks.BED.getDefaultState().withProperty(BlockBed.FACING, EnumFacing.SOUTH).withProperty(BlockBed.PART, BlockBed.EnumPartType.FOOT), 0);
    ...
    private void setBlock(World world, StructureBoundingBox sbb, int x, int y, int z, IBlockState s, int metadata) {
        ...
        if(s == Blocks.LOG2.getDefaultState()) {
            ...
            setBlockState(world, Blocks.LADDER.getStateFromMeta(metadata), x, y, z, sbb);
        }
