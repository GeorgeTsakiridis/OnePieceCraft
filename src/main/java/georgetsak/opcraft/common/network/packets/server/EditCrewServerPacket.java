...
public class EditCrewServerPacket extends AbstractMessage.AbstractServerMessage<EditCrewServerPacket> {
    ...
    public EditCrewServerPacket(String operation, String param1, int param2){
    ...
    public void process(EntityPlayer player, Side side) {
        ...
        if(operation.equals("create") && !param1.isEmpty() &&CrewUtils.isCrewNameAvailable(crewSaveData.getCrews(), param1)) {
            ...
            if(target != null && crew != null){
                ...
                PacketDispatcher.sendTo(new CrewInviteClientPacket(crew.getName()), (EntityPlayerMP)target);
            }
        }
        ...
        PacketDispatcher.sendTo(new StatsNormalClientPacket(StatsNormalCap.get(player)),(EntityPlayerMP) player);//Make the stats to refresh in client in order to update the Doctor increased life perk.
    }
