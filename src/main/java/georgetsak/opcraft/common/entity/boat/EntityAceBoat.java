...
public class EntityAceBoat extends Entity
{
    ...
    public EntityAceBoat(World worldIn)
    {
        super(worldIn);
    ...
    public EntityAceBoat(World worldIn, double x, double y, double z)
    {
        this(worldIn);
        ...
        else if (!this.world.isRemote && !this.isDead)
        {
            ...
            else
            {
                ...
                if (flag || this.getDamageTaken() > 80.0F)
                {
                    ...
                    {
                        this.dropItemWithOffset(OPItems.ItemAceBoat, 1, 0.0F);
                    }
    ...
    {
        if (entityIn instanceof EntityAceBoat)
        {
    ...
    public void onUpdate()
    {
        ...
        if (this.canPassengerSteer())
        {
            ...
            this.move(MoverType.SELF, this.motionX*2D, this.motionY*2D, this.motionZ*2D);
        }
        else
        {
            this.motionX = 0.0D;
    ...
    {
        Status EntityAceBoat$status = this.getUnderwaterStatus();

        if (EntityAceBoat$status != null)
        {
    ...
    @Nullable
    private EntityAceBoat.Status getUnderwaterStatus()
    {
        AxisAlignedBB axisalignedbb = this.getEntityBoundingBox();
                ...
                if (this.fallDistance > 3.0F)
                {
                    ...
                    if (!this.world.isRemote && !this.isDead)
                    {
                        ...
                        if (this.world.getGameRules().getBoolean("doEntityDrops"))
                        {
                            for (int i = 0; i < 3; ++i)
                            {
                                this.entityDropItem(new ItemStack(OPItems.ItemAceBoat), 0.0F);
                            }
