...
public class EntityMarine extends EntityBounty
{
    ...
    public EntityMarine(World worldIn)
    {
        ...
        setMarineType(new Random().nextInt(3) + 1);
        setBounty(100);
    }

    public EntityMarine(World worldIn, BlockPos position){
        this(worldIn);
        this.setPosition(position.getX(), position.getY(), position.getZ());
    }

    public void setMarineType(int type){
    ...
    public void readEntityFromNBT(NBTTagCompound compound)
    {
        ...
        setMarineType(compound.getInteger("type"));
