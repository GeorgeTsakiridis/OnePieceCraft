...
public class ModelPirateFat extends ModelBase {
    ...
    public ModelPirateFat() {
        this.textureWidth = 64;
        this.textureHeight = 64;

        this.body = new ModelRenderer(this, 0, 33);
        this.body.setRotationPoint(-1.0F, 0.0F, 0.0F);
        this.body.addBox(-4.0F, 0.0F, -3.2F, 10, 12, 6);
        this.armUpR = new ModelRenderer(this, 31, 13);
        ...
        this.armLowR = new ModelRenderer(this, 31, 0);
        this.armLowR.setRotationPoint(1.8F, 4.0F, 1.5F);
        this.armLowR.addBox(-3.0F, 0.0F, -4.0F, 4, 8, 4);
        this.setRotationAngles(this.armLowR, -0.7925540106674639F, 0.0F, 0.0F);
        this.armUpR.addChild(this.armLowR);
        this.armUpL = new ModelRenderer(this, 48, 13);
        ...
        this.armLowL = new ModelRenderer(this, 48, 0);
        this.armLowL.setRotationPoint(0.0F, 4.0F, 1.5F);
        this.armLowL.addBox(-3.0F, 0.0F, -4.0F, 4, 8, 4);
        this.setRotationAngles(this.armLowL, -0.7925540106674639F, 0.0F, 0.0F);
        this.armUpL.addChild(this.armLowL);
        this.legUpR = new ModelRenderer(this, 46, 25);
        this.legUpR.setRotationPoint(3.4F, 12.1F, 0.5F);
        this.legUpR.addBox(-2.0F, 0.0F, -2.0F, 5, 6, 4);
        this.legUpR.mirror = true;
        this.setRotationAngles(this.legUpR, -0.0F, 0.0F, -0.08726646259971647F);
        this.body.addChild(this.legUpR);
        this.legLowR = new ModelRenderer(this, 50, 37);
        this.legLowR.setRotationPoint(0.5F, 5.9F, 0.1F);
        this.legLowR.addBox(-2.0F, 0.0F, -2.0F, 4, 6, 3);
        ...
        this.legUpL = new ModelRenderer(this, 46, 25);
        this.legUpL.setRotationPoint(-2.4F, 12.1F, 0.5F);
        this.legUpL.addBox(-2.0F, 0.0F, -2.0F, 5, 6, 4);
        this.setRotationAngles(this.legUpL, 0.0F, 0.0F, 0.08726646259971647F);
        this.body.addChild(this.legUpL);
        this.legLowL = new ModelRenderer(this, 50, 37);
        this.legLowL.setRotationPoint(0.2F, 5.9F, 0.1F);
        this.legLowL.addBox(-2.0F, 0.0F, -2.0F, 4, 6, 3);
        this.setRotationAngles(this.legLowL, 0.0F, 0.0F, -0.08726646259971647F);
        this.legUpL.addChild(this.legLowL);
        this.body2 = new ModelRenderer(this, 1, 19);
        this.body2.setRotationPoint(-1.0F, 0.5F, -1.0F);
        this.body2.addBox(-4.0F, 0.0F, -2.0F, 12, 7, 6);
        this.body.addChild(this.body2);
        this.body3 = new ModelRenderer(this, 44, 56);
        this.body3.setRotationPoint(2.0F, 10.0F, 0.0F);
        this.body3.addBox(-4.0F, 0.0F, -1.9F, 6, 4, 4);
        this.body.addChild(this.body3);
        this.belly = new ModelRenderer(this, 0, 51);
        this.belly.setRotationPoint(-1.0F, 6.6F, -1.3F);
        this.belly.addBox(-4.0F, 0.0F, -2.2F, 12, 6, 7);
