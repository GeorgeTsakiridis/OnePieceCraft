...
public class ModelPirateThin extends ModelBase {
    ...
    public ModelPirateThin() {
            this.textureWidth = 64;
            this.textureHeight = 64;

            this.body = new ModelRenderer(this, 0, 47);
            this.body.setRotationPoint(-1.0F, 0.8F, 0.0F);
            this.body.addBox(-4.0F, 0.0F, -2.2F, 9, 12, 5);
            this.armUpR = new ModelRenderer(this, 50, 13);
            this.armUpR.setRotationPoint(-3.9F, 2.4F, 0.0F);
            this.armUpR.addBox(-3.0F, -2.0F, -2.0F, 3, 7, 4);
            this.armUpR.mirror = true;
            this.setRotationAngles(this.armUpR, -0.011693706279645253F, -0.0015707963892127347F, -0.001745329278001762F);
            this.body.addChild(this.armUpR);
            this.armLowR = new ModelRenderer(this, 54, 26);
            this.armLowR.setRotationPoint(0.5F, 5.0F, 1.5F);
            this.armLowR.addBox(-3.0F, 0.0F, -4.0F, 2, 7, 3);
            this.setRotationAngles(this.armLowR, -0.7925540106674639F, 0.0F, 0.0F);
            this.armUpR.addChild(this.armLowR);
            this.armUpL = new ModelRenderer(this, 33, 13);
            this.armUpL.setRotationPoint(3.7F, 2.4F, 0.0F);
            this.armUpL.addBox(1.0F, -2.0F, -2.0F, 3, 7, 4);
            this.body.addChild(this.armUpL);
            this.armLowL = new ModelRenderer(this, 39, 26);
            ...
            this.legUpR = new ModelRenderer(this, 30, 40);
            this.legUpR.setRotationPoint(3.0F, 11.5F, 0.5F);
            ...
            this.legLowR = new ModelRenderer(this, 38, 55);
            ...
            this.legUpL = new ModelRenderer(this, 48, 40);
            this.legUpL.setRotationPoint(-1.9F, 11.5F, 0.5F);
            ...
            this.legLowL = new ModelRenderer(this, 52, 55);
            ...
            this.body3 = new ModelRenderer(this, 3, 6);
