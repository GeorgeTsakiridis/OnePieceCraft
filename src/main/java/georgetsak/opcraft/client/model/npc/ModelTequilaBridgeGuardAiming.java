...
public class ModelTequilaBridgeGuardAiming extends ModelBase {
        ...
        public ModelTequilaBridgeGuardAiming() {
                textureWidth = 128;
                textureHeight = 128;
                ...
                setRotationAngle(gun, -0.2618F, 0.5236F, -0.9599F);
                armL.addChild(gun);
                gun.cubeList.add(new ModelBox(gun, 32, 23, -0.877F, -0.8842F, -5.3101F, 5, 2, 2, 0.0F, false));
                gun.cubeList.add(new ModelBox(gun, 54, 0, -8.877F, -0.8842F, -5.3101F, 4, 1, 2, 0.0F, false));
                gun.cubeList.add(new ModelBox(gun, 0, 0, -3.877F, -0.8842F, -5.3101F, 1, 2, 2, 0.0F, false));
                gun.cubeList.add(new ModelBox(gun, 44, 54, -10.877F, -1.8842F, -5.3101F, 12, 1, 2, 0.0F, false));
